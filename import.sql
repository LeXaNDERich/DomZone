-- Импортируй этот файл в уже созданную/выбранную БД в phpMyAdmin.
-- Здесь НЕТ CREATE DATABASE / USE, чтобы не требовались права на создание БД.
...
-- Если ты импортируешь в старую БД без этой колонки, добавь её вручную одной командой:
...
UPDATE `products` SET `image_path` = '/assets/image/1.jpg' WHERE `name` = 'Швабра с отжимом ProClean';
UPDATE `products` SET `image_path` = '/assets/image/2.jpg' WHERE `name` = 'Набор отверток Master 12в1';
UPDATE `products` SET `image_path` = '/assets/image/3.jpg' WHERE `name` = 'Органайзер для специй';
UPDATE `products` SET `image_path` = '/assets/image/4.jpg' WHERE `name` = 'Секатор садовый SharpCut';
UPDATE `products` SET `image_path` = '/assets/image/5.jpg' WHERE `name` = 'Перчатки хозяйственные UltraGrip';
UPDATE `products` SET `image_path` = '/assets/image/6.jpg' WHERE `name` = 'Ящик для инструментов BuildBox';
UPDATE `products` SET `image_path` = '/assets/image/7.jpg' WHERE `name` = 'Универсальное чистящее средство CleanMax';
UPDATE `products` SET `image_path` = '/assets/image/8.jpg' WHERE `name` = 'Набор инструментов ToolBox Home';
